<template>
    <section class="main_container text-center !py-[5rem]" id="services">
        <h1 class="text-[20px] tracking-[.6rem] uppercase font-bold mb-[1rem]">Our Services</h1>
        <p class="mb-[2rem] sm:text-[20px] text-[gray] mx-auto max-w-[800px] w-full">Lorem ipsum dolor sit amet
            consectetur, adipisicing elit. Necessitatibus voluptas inventore nihil veniam
            dicta ducimus perferendis voluptatibus voluptatum facilis praesentium!</p>
        ...
        <div class="flex flex-wrap justify-center gap-[2rem]">
            ...
            <div class="flex w-full flex-col max-w-[250px] justify-center items-center">
                <div class="p-[1rem] text-client_color rounded-full">
                    ...
                    <Icon size="40" name="ri:whatsapp-line" />
                </div>
